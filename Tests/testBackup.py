...
def mainFunction():
	...
	# Understanding who user is	interacting with
		...
		talkBack("I am an Interactive Voice Assistant made by X.", "who")
	...
	# Understanding who Reena is
		 ...
		 talkBack("My name is Reena! I am a Resolution and Enablement specialist made by my friends at X.", "name")
	...
	# Helping users get the dinner menu of the day
		...
		webbrowser.open("https://goodboxapp.com/X4cafeteria-sodexo-app", new = 1)
	...
	# Start of the troubleshooting code to integrate answerflow into Reena
		...
		talkBack("Alright, we need to check if there are any damages on the X's AC Adapter or the DC Port", "powerKnownIssueNoHardResetYesACAdapterNoDamageNo")
		...
		talkBack("Okay, it looks like the power cord is causing this problem and what I am going to do is, send a new power cord to the registered address on your X account.", "powerKnownIssueNoHardResetNoACAdapterNoDamageYesAdapterYesCord")
	elif "didn't" in convertedAudioSplit:
		talkBack("Okay, it looks like the adapter you have is causing this problem and what I am going to do is, send a new adapter to the registered address on your X account.", "powerKnownIssueNoHardResetNoACAdapterNoDamageYesAdapterYesCordNo")
	elif "nothing" in convertedAudioSplit:
		talkBack("Okay, it looks like the adapter and the power cord are faulty and what I am going to do is send a new set of adapter and power cord to the registered address on your X Account.", "powerKnownIssueNoHardResetNoACAdapterNoDamageYesAdapterYesCordNoFit")
...
def troubleshoot():
	...
	if "yes" in convertedAudioTroubleshootSplit:
		talkBack("I’m sorry to hear that, let me connect you to a X Technical Representative through chat, who will help you further", "physicalDamageOnDisplayYes")
		webbrowser.open("https://www.X.com/learn/us/en/uscorp1/campaigns/chat-splitter", new = 1)
		...
		if "yes" in convertedaAudioSplit:
			...
			if "yes" in convertedbAudioSplit:
				...
				if "yes" in convertedcAudioSplit:
					...
					os.system("SupportAssist.exe RunDiags silent=false script=Display_Touch  key=98546726a7d1c084de4977ebfb90fa74b5f1efd1")
					talkBack("Looks like the LCD needs to be replaced and I am going to take care of that for you", "physicalDamageOnDisplayNoCleanNoProtectorNoResolvedNoSA")
...
root.title("X - ReEna (Resolve, Enable) - Interactive Voice Assistant")
